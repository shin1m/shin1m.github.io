...
(function() {
  ...
  Player = (function() {
    ...
    load = function(skin, source, next) {
      var fps, read_action, read_ready_action, read_run, read_run_actions, read_shot, read_swing, read_swing_actions, request, source_fps;
      source_fps = null;
      fps = 64.0;
      ...
      return loader.load(model + '.dae', (function(_this) {
        return function(collada) {
          ...
          return load(collada.skins[0], model + '.player', function(actions) {
            ...
            console.log(_this.root.position);
    ...
    Player.prototype.relative_ball = function(swing) {
      var p, x, y, z;
      p = this.node.worldToLocal(this.ball.position.clone());
    ...
    Player.prototype.smash_height = 2.25;
    ...
    Player.prototype.state_default = State(function() {
      ...
      var actions, hand, swing, t, whichhand;
      ...
      hand = whichhand > 0.0 ? actions.forehand : actions.backhand;
      if (this.ball.done) {
        this.set_motion(new Motion(this.node.position.z * this.end > 21 * 12 * 0.0254 ? hand.stroke[shot] : hand.volley));
      } else {
        this.set_motion(new Motion(t < (hand.volley.impact - hand.volley.start) * 60.0 ? hand.stroke[shot] : hand.volley));
      }
    ...
    Player.prototype.state_swing = State(function() {
      ...
      var a, b, ball, d, dd, dx, dz, n, nh, speed, spin, v, vm;
