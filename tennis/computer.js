...
(function() {
  ...
  exports.controller = function(controller, player) {
    var backward, ball, decided0, decided1, duration, forward, left, net, reset_decision, reset_move, right, shot, super__step;
    ball = this.ball;
    duration = 1.0 * 64.0;
    ...
    reset_move = function() {
      return player.left = player.right = player.forward = player.backward = false;
    };
    super__step = controller.step;
    return controller.step = (function(_this) {
      return function() {
        var a, actions, bound_position, bound_t, d, dt, epsilon, hand, i, ix, iz, point, position, side0, side1, swing, t, t0, t1, target, tt, v, velocity, whichhand, z, zt;
        if (ball.done) {
          reset_move();
          reset_decision();
          net = false;
          ...
          t = projected_time_for_y(position.y, velocity.y, Player.prototype.smash_height, 1.0);
          if (t !== null) {
