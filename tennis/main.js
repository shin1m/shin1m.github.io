...
(function() {
  ...
  Training = (function(superClass) {
    ...
    Training.prototype.reset = function(x, y, z, position, shot) {
      this.ball.reset(this.side, x, y, z);
      this.mark.duration = 0.0;
    ...
    trainings = {
      ...
      smash: {
        reset: function() {
          this.reset(3 * 12 * 0.0254 * this.side, 1.0, -39 * 12 * 0.0254, new THREE.Vector3((0.4 - 0.4 * this.side) * 12 * 0.0254, 0.0, 11.5 * 12 * 0.0254), 'toss_lob');
          this.set_instruction(toss_message);
          return this.duration = 0.5 * 64.0;
        },
        play: function() {
