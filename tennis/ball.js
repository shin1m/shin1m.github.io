...
(function() {
  ...
  Ball = (function() {
    ...
    Ball.prototype.record = function(to) {
      to.position = this.position.clone();
      to.velocity = this.velocity.clone();
      return to.spin = this.spin.clone();
    };

    Ball.prototype.replay = function(from) {
      this.position.copy(from.position);
      this.velocity.copy(from.velocity);
      return this.spin.copy(from.spin);
    };
  ...
  Mark = (function() {
    ...
    Mark.prototype.setup = function() {
      this.node.visible = this.duration > 0;
    ...
    Mark.prototype.create_record = function() {
      var record;
      record = {};
      this.record(record);
      return record;
    ...
    Mark.prototype.record = function(to) {
      to.duration = this.duration;
      to.stretch = this.stretch;
      to.position = this.node.position.clone();
      return to.quaternion = this.node.quaternion.clone();
    };

    Mark.prototype.replay = function(from) {
      this.duration = from.duration;
      this.stretch = from.stretch;
      this.node.position.copy(from.position);
      return this.node.quaternion.copy(from.quaternion);
    };
